...
# The order is finnicky here and reordering the `rustup target add wasm32-unknown-unknown` caused the build to fail. Is this optimal for the cache? Not sure.
