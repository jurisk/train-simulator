...
wasm-bindgen --out-name single-player-client --out-dir client/single-player/web/wasm-build --target web target/wasm32-unknown-unknown/wasm-release/single-player-client.wasm
----
