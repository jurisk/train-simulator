...
* Number row `1`, `2`, `3` for "test objects" building
...
cargo run --features bevy/dynamic_linking --package networking-client --bin client_graphical -- ws://127.0.0.1:8080/ws ee6b4aa1-67e0-4d6b-a42c-56320f61390e
----
